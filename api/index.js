...
function getProducts(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, color.name AS color, products.code AS code, products.price AS price FROM products JOIN color ON products.color_id = color.id JOIN merken ON merk_id = merken.id ORDER BY name ASC')
